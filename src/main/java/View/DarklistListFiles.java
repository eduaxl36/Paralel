 ...
 */
public class DarklistListFiles extends javax.swing.JFrame {
             ...
             public void run(){
                ...
                try {
                       ...
                       progressFrame.setVisible(false);;
                        ...
                        Logger.getLogger(DarklistListFiles.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (Exception ex) {
                        Logger.getLogger(DarklistListFiles.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public DarklistListFiles() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        tbPane.addTab("List de dark", jPanel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DarklistListFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
