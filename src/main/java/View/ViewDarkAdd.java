...
public class ViewDarkAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pn.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 160, 30));
        pn.add(Txt_HouseHold, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 160, 30));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/datainicio.png"))); // NOI18N
        jLabel3.setText("  Inicio");
        pn.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 160, 30));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/datafinal.png"))); // NOI18N
        jLabel4.setText("   Cerramiento");
        pn.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 160, 20));
        ...
        pn.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, 40, 40));
        pn.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 410, 310, 10));
        pn.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 8, 340, 20));
        pn.add(finalHouseHoldDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 160, -1));
    ...
    pn.add(InitialHouseHoldDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 160, -1));

    TxtComment.setColumns(20);
    TxtComment.setRows(5);
    jScrollPane1.setViewportView(TxtComment);

    pn.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 160, 60));

    lblUserName.setText("TESTE");
    pn.add(lblUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 420, 170, 30));

    jLabel6.setText("Cambiado Por  : ");
    pn.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 90, 30));
    ...
    layout.setVerticalGroup(
        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addComponent(pn, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE)
    );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
             ...
             int resposta = JOptionPane.showConfirmDialog(null, "Desea añadir el logar en darklist?", 
                     "Confirmacion", 
