 ...
 */
public final class WhiteManagerViewClient extends javax.swing.JFrame {
    ...
    public WhiteManagerViewClient() throws IOException, Exception {
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        try {
            ...
            Logger.getLogger(WhiteManagerViewClient.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        new WhiteManagerViewClient().setVisible(true);
